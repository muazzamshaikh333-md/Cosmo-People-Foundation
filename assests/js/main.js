...
const bannerSlider = new Swiper('.ul-banner-2-slider', {
  // Slow autoplay - 6 seconds per slide
  autoplay: {
    delay: 6000,              // Time each slide stays visible (6 seconds)
    disableOnInteraction: false, // Keeps autoplay running after user interacts
  },
  
  // Slow, smooth transition between slides
  speed: 1200,                // Transition animation takes 1.2 seconds
  ...
  loop: true,
  effect: 'fade',             // Smooth fade instead of slide (optional)
  fadeEffect: {
    crossFade: true
  },
  ...
  // Thumb slider sync (if you're using it)
  thumbs: {
    swiper: thumbSlider  // Reference to your thumbnail slider
  }
});
